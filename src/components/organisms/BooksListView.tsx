...
import { BookDashed, Heart } from 'lucide-react'
...
const BooksListView = ({
                ...
                <div className="flex w-4/6 flex-col p-4 xs:w-[calc(100%-9rem)] lg:flex-row">
                  ...
                  <div className="mt-2 flex w-full flex-grow items-end justify-end lg:w-28 lg:flex-shrink-0 lg:flex-col lg:items-center lg:justify-center">
                    {(onLoan || onReturn) && (
                      <Button
                        variant={
                          status === 'CHECKED_OUT' ? 'outline' : 'default'
                        }
                        size="sm"
                    ...
                    {onDelete && (
                      <Button
                        variant="outline"
                        size="sm"
                        className="ml-2 w-1/2 max-w-28 border-2 border-destructive text-destructive hover:bg-destructive hover:text-white disabled:opacity-30 lg:ml-0 lg:mt-2 lg:w-full"
  ...
  return (
    <div className="flex h-full flex-grow flex-col items-center justify-center text-tertiary">
